"""
Django settings for uFoundIt backend.
"""
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'channels',
    # 'storages',  # Optional - uncomment for S3 support
    # 'drf_spectacular',  # Optional - uncomment for API documentation
...
DATABASES = {
    'default': {
        ...
        # 'NAME': os.getenv('DB_NAME', 'ufoundit'),
...
# For production with Redis, use this configuration instead:
# CHANNEL_LAYERS = {
#     'default': {
